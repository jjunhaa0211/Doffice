...
public enum SpriteCatalog {
    ...
    // ── 정면 (down) idle ──
    public static let charDownIdle: [[String]] = [
        // row 0-3: 머리카락
        ["","","","","","H","H","H","H","H","H","","","","",""],
        ["","","","","H","H","H","H","H","H","H","H","","","",""],
        ["","","","H","H","H","H","H","H","H","H","H","H","","",""],
    ...
    public static let charDownWalk1: [[String]] = {
        var s = charDownIdle
        s[17] = ["","","","","","P","P","P","","P","P","","","","",""]
        s[18] = ["","","","","P","P","P","","","P","P","P","","","",""]
        s[19] = ["","","","","P","P","P","","P","P","P","","","","",""]
    ...
    public static let charDownWalk2: [[String]] = {
        var s = charDownIdle
        s[17] = ["","","","","","P","P","","P","P","P","","","","",""]
        s[18] = ["","","","","P","P","","","","P","P","P","","","",""]
        s[19] = ["","","","","P","P","P","","","P","P","P","","","",""]
    ...
    // ── 정면 typing frame 0 ──
    public static let charDownType0: [[String]] = {
        var s = charDownIdle
        // 팔 올림 (타이핑 자세)
    ...
    // ── 정면 typing frame 1 ──
    public static let charDownType1: [[String]] = {
        var s = charDownIdle
        s[11] = ["","","S","T","T","T","T","T","T","T","T","T","T","S","",""]
        s[12] = ["","S","S","","T","T","T","T","T","T","T","T","","S","S",""]
        s[13] = ["","","","","T","T","T","T","T","T","T","T","","","",""]
    ...
    // ── 뒷면 (up) idle ──
    public static let charUpIdle: [[String]] = [
        ["","","","","","H","H","H","H","H","H","","","","",""],
        ["","","","","H","H","H","H","H","H","H","H","","","",""],
        ["","","","H","H","H","H","H","H","H","H","H","H","","",""],
        ["","","","H","H","H","H","H","H","H","H","H","H","","",""],
    ...
    public static let charUpWalk1: [[String]] = {
    ...
    public static let charUpWalk2: [[String]] = {
        replacingRows(charUpIdle, with: [
    ...
    public static let charUpType0: [[String]] = {
        replacingRows(charUpIdle, with: [
    ...
    public static let charUpType1: [[String]] = {
        replacingRows(charUpIdle, with: [
            10: ["","","","T","T","T","T","T","T","T","T","T","T","","",""],
            11: ["","S","S","","T","T","T","T","T","T","T","T","","S","S",""],
            12: ["","","S","S","T","T","T","T","T","T","T","T","S","S","",""],
    ...
    // ── 오른쪽 (right) idle ──
    public static let charRightIdle: [[String]] = [
        ["","","","","","","H","H","H","H","H","","","","",""],
        ["","","","","","H","H","H","H","H","H","H","","","",""],
        ["","","","","H","H","H","H","H","H","H","H","","","",""],
        ["","","","","H","H","H","H","H","H","H","H","","","",""],
    ...
    public static let charRightWalk1: [[String]] = {
    ...
    public static let charRightWalk2: [[String]] = {
        replacingRows(charRightIdle, with: [
    ...
    public static let charRightType0: [[String]] = {
        replacingRows(charRightIdle, with: [
            10: ["","","","","T","T","T","T","T","T","T","T","","","",""],
    ...
    public static let charRightType1: [[String]] = {
        replacingRows(charRightIdle, with: [
            10: ["","","","","T","T","T","T","T","T","T","T","","","",""],
    ...
    /// 좌우 반전
    public static func flipHorizontal(_ sprite: SpriteData) -> SpriteData {
        sprite.map { $0.reversed() }
    }

    /// 완성된 캐릭터 스프라이트 세트 생성
    public static func buildCharacterSprites(skin: String, hair: String, shirt: String, pants: String = "3A4050") -> CharacterSpriteSet {
    ...
    /// 책상 (3x1 타일 = 48x16)
    public static let desk: SpriteData = {
        let w = 48, h = 16
    ...
    /// 모니터 (1x1 타일 = 16x16)
    public static let monitor: SpriteData = {
    ...
    /// 의자 (1x1 = 16x16)
    public static let chair: SpriteData = {
        var rows = Array(repeating: Array(repeating: "", count: 16), count: 16)
        // 등받이
    ...
    /// 화분 (1x1 = 16x16)
    public static let plant: SpriteData = {
        var rows = Array(repeating: Array(repeating: "", count: 16), count: 16)
        // 잎 (위쪽)
    ...
    /// 커피머신 (1x1 = 16x16)
    public static let coffeeMachine: SpriteData = {
        var rows = Array(repeating: Array(repeating: "", count: 16), count: 16)
    ...
    /// 소파 (3x2 = 48x32)
    public static let sofa: SpriteData = {
        let w = 48, h = 32
        var rows = Array(repeating: Array(repeating: "", count: w), count: h)
    ...
    /// 화이트보드 (3x1 = 48x16)
    public static let whiteboard: SpriteData = {
        let w = 48, h = 16
        var rows = Array(repeating: Array(repeating: "", count: w), count: h)
        // 프레임
    ...
    /// 책장 (2x1 = 32x16)
    public static let bookshelf: SpriteData = {
        let w = 32, h = 16
        var rows = Array(repeating: Array(repeating: "", count: w), count: h)
        // 프레임
